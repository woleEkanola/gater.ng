...
CREATE TABLE "User" (
    ...
    "transactionFeePercent" DOUBLE PRECISION DEFAULT 5.0,
...
-- AddForeignKey
ALTER TABLE "CheckIn" ADD CONSTRAINT "CheckIn_checkedBy_fkey" FOREIGN KEY ("checkedBy") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
