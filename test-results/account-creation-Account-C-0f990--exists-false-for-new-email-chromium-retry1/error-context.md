...
- Name: account-creation.spec.ts >> Account Creation APIs >> POST /api/auth/check-email - should return exists=false for new email
- Location: tests\e2e\account-creation.spec.ts:4:7
