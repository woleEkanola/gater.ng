...
- Name: account-creation.spec.ts >> Public Pages >> should load homepage
- Location: tests\e2e\account-creation.spec.ts:65:7
...
Locator: getByRole('heading', { name: 'Discover events that inspire' })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Discover events that inspire' })
