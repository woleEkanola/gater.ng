...
- Name: account-creation.spec.ts >> Public Pages >> should load events page
- Location: tests\e2e\account-creation.spec.ts:70:7
...
Locator: getByRole('heading', { name: 'Upcoming Events' })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Upcoming Events' })
