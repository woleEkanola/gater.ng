...
- Name: new-features.spec.ts >> Homepage >> should load homepage with hero section
- Location: tests\e2e\new-features.spec.ts:4:7
...
Locator: locator('text=Discover events that')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Discover events that')
