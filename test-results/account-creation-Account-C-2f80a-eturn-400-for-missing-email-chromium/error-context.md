...
- Name: account-creation.spec.ts >> Account Creation APIs >> POST /api/auth/send-magic-link - should return 400 for missing email
- Location: tests\e2e\account-creation.spec.ts:48:7
