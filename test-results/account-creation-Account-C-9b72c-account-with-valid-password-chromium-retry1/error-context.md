...
- Name: account-creation.spec.ts >> Account Creation APIs >> POST /api/auth/create-account - should create account with valid password
- Location: tests\e2e\account-creation.spec.ts:19:7
