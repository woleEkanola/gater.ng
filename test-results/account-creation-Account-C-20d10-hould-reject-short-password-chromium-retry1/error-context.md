...
- Name: account-creation.spec.ts >> Account Creation APIs >> POST /api/auth/create-account - should reject short password
- Location: tests\e2e\account-creation.spec.ts:27:7
