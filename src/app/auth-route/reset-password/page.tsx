      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-rose-50 to-background p-4">
        <Card className="w-full max-w-md">
          <CardContent className="pt-6 text-center">
            ...
            <Link href="/auth-route/forgot-password" className="text-rose-600 hover:underline text-sm mt-4 inline-block">
              Try again
            </Link>
          </CardContent>
        </Card>
        ...
        <CardContent>
          {isSuccess ? (
            <div className="text-center space-y-4">
              ...
              <Link href="/auth-route/login" className="text-rose-600 hover:underline text-sm">
                Go to login
              </Link>
            </div>
          ) : (
